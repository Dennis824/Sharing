...
import com.example.Sharing.services.CarService;
import com.example.Sharing.services.OrderService;
...
public class OrderController {
    ...
    @PreAuthorize("hasAuthority('USER')")
    public String addOrder(@Valid @ModelAttribute("object") Order object, BindingResult bindingResult, Model model) {
        try {
            Authentication auth = SecurityContextHolder.getContext().getAuthentication();
            User user = userService.findByEmail(auth.getName());
            object.setUser(user);
